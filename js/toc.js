...
(function ($) {
    ...
    function Stack () {
        ...
        this.peek = peek
        this.length = length;
        this.toc_number = toc_number;//if you already have toc_number, repalce it by () => "";
    ...
    $.fn.toc = function (options) {
        var defaults = {
            ...
            showEffect: 'show|slideDown|fadeIn', // values: [show|slideDown|fadeIn|none]
            showSpeed: 3 // set to 0 to deactivate effect
        },
